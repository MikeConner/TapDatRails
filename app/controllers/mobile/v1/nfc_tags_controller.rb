class Mobile::V1::NfcTagsController < ApiController
  ...
  def update
    if params[:tag].blank?
      error! :bad_request, :metadata => {:error_description => I18n.t('missing_argument', :arg => 'tag'), :user_error => I18n.t('tag_update_error') } 
    elsif params[:tag_id].blank? and (0 == params[:id].to_i)
